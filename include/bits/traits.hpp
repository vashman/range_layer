...
/*template <typename R> inline constexpr bool is_range_v       = is_range<R>::value;
template <typename R> inline constexpr bool is_synced_v      = is_synced<R>::value;
template <typename R> inline constexpr bool is_output_v      = is_output<R>::value;
template <typename R> inline constexpr bool is_input_v       = is_input<R>::value;
template <typename R> inline constexpr bool is_finite_v      = is_finite<R>::value;
template <typename R> inline constexpr bool is_next_linear_v = is_next_linear<R>::vlaue;
template <typename R> inline constexpr bool is_prev_linear_v = is_prev_linear<R>::vlaue;
template <typename R> inline constexpr bool is_reversable_v  = is_reversable<R>::value;
template <typename R> inline constexpr bool is_decorator_v   = is_decorator<R>::value;
*/
} //-----------------------------------------------------------------range layer
#endif
