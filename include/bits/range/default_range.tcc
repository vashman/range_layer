...
#ifndef RANGE_LAYER_BITS_DEFAULT_RANGE_TCC
#define RANGE_LAYER_BITS_DEFAULT_RANGE_TCC
...
, range<T * const> {&(range::base_from_member::member)}
{}
...
: range::base_from_member {_var}
, range<const T * const> {&(range::base_from_member::member)}
{}
